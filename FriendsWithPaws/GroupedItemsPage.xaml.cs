...
namespace FriendsWithPaws
{
    ...
    /// </summary>
    public sealed partial class GroupedItemsPage : FriendsWithPaws.Common.LayoutAwarePage
    {
        ...
        void Header_Click(object sender, RoutedEventArgs e)
        {
            ...
            this.Frame.Navigate(typeof(GroupDetailPage), ((BreedDataGroup)group).UniqueId);
        }
